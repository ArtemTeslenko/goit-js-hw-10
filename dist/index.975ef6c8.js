...
inputEl.addEventListener("input", (0, _throttleDebounce.debounce)(1500, onInput));
function onInput(e) {
    const val = e.target.value;
    (0, _fetchCountries.fetchCountries)(val);
}

},{"./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","throttle-debounce":"81w4t"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
